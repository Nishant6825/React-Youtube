...
export default function TextForm(props) {
    ...
    return (
        <>
            <div className='container' style={{ color:props.mode === 'light' ? 'black' : 'white', backgroundColor: props.mode === 'light' ? 'white' : '#8443c3' }}>
                <h2>{props.heading}</h2>
                {/* <div className="mb-3"> */}
                    <label htmlFor="myBox" className="form-label">Text Area</label>
                    <textarea className="form-control" value={text} onChange={handleEvent} style={{ color:props.mode === 'light' ? 'black' : 'white' ,backgroundColor: props.mode === 'light' ? 'white' : '#8443c3' }} id="myBox" rows="7" placeholder='Chal maal daaal....'></textarea>
                {/* </div> */}
            ...
            <div className="container"style={{ backgroundColor: props.mode === 'light' ? 'white' : '#8443c3', color:props.mode === 'light' ? 'black' : 'white' }}>
                <h1>This is a summary of text</h1>
                <p>This summary have {text.length === ' ' ? '0' : text.split(' ').length} words and {text.replace(/\s/g, '').length} letters in it  </p>
                <h2>Preview <br /></h2>
